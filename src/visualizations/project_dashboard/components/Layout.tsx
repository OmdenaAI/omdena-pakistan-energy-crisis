...
const Layout = (props: any) => {
  return (
    <>
      <Head>
        <link rel='icon' href='/images/omdena-pk.png' />
        ...
        <title>Potential Solar Powerplant Sites | Omdena Pakistan</title>
        <link
        ...
        <script
          async
          src='https://www.googletagmanager.com/gtag/js?id=G-QLS9Q801BN'
        ></script>
        <script
