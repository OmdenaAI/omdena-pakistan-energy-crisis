  ...
  return (
    <>
      ...
      <div className="research-tab px-1 mt-5 pt-5">
        <h2 className="mt-0">Population and Energy information</h2>
        <p>
          According the Pakistan Bureau of Statistics data an estimated{" "}
          ...
          </span>And According to DHS survey and studies{" "}
          there are 0.5% Urban and 11.5% Rural households, that have limited access to electricity in Pakistan.
        </p>

        <h2 className="mt-4">Hope in Solar Energy</h2>
        <img
          src="https://images.unsplash.com/photo-1624062166046-fc8a8e0e9c9a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=20"
        ...
        <p>
          According to the{" "}
          <a
            href="https://data.worldbank.org/indicator/EG.USE.ELEC.KH.PC?locations=PK"
            target="_blank"
          >
            Wordbank (2014)
          </a>
          , On average, the household electricity consumption (per capita) in
          the Pakistan is about{" "}
          <span className="text-primary">448 kWh, per year </span>and 529 kWh, per year PEPCO (2019).
        </p>
        ...
        <h2 className="mt-4">Energy scene in the Pakistan</h2>

        <p>
          Based on the <a href='https://en.wikipedia.org/wiki/List_of_power_stations_in_Pakistan'>Wikipedia</a> The Power stations types in
          the Pakistan are as follows:
        </p>
        <div className="mt--5">
          <RadialAreaChart
        ...
        <p>
          ...
          country and third is natural gas again non-renewable. The Pakistan is still lacking in the utilization of other
          ...
          renewable energy sources.Pakistan is also reliant on Nuclear Energy resources. To help address the country's growing demand
          for energy, in a cleaner and more efficient way.
        </p>

        <h2 className="mt-4">Need for renewable energy</h2>
        <p>
          Using the<a href='https://en.wikipedia.org/wiki/List_of_power_stations_in_Pakistan'>Wikipedia</a> we can see which types of power
